...
class SampleTypeAttributeBuilder
{
    ...
    public static function aBriefTextAttribute(SampleTypeTemplateAttribute $template)
    {
        return (new self())
            ->withValue('Brief text')
            ->setTemplate($template);
    }

    public static function aLongTextAttribute(SampleTypeTemplateAttribute $template)
    {
        $text = <<<'EOF'
